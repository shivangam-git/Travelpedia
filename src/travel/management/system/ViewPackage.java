...
ResultSet rs=c.s.executeQuery("select * from BookPackage where username ='"+username+"'");          // System.out.println("vv");
           while(rs.next()){
